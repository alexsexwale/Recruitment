...
router.get("/vetted", async (req, res) => {
  var vetted = [];
...
router.get("/micros", async (req, res) => {
  var micros = [];
...
router.get("/studentRatings", async (req, res) => {
  var studentRatings = [];
...
router.get("/clientRatings", async (req, res) => {
  var clientRatings = [];
...
router.get("/problemSolving", async (req, res) => {
  var problemSolving = [];
...
router.get("/dissatisfied", async (req, res) => {
  var dissatisfied = [];
...
router.get("/netcash", async (req, res) => {
  var netcash = [];
