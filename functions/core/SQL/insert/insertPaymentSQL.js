...
async function insertPaymentSQL(snap) {
    ...
    var sql = "REPLACE INTO Payments (job_ID, payment_date, budget, service_fee, admin_fee, total_cost_paid, inbound_payment, outbound_payment, payment_method, reference, last_modified, created) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
