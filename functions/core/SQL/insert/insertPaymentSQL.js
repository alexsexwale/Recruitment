...
async function insertPaymentSQL(snap) {
    ...
    var sql = "INSERT INTO Payments (job_ID, payment_date, budget, service_fee, admin_cost, total_cost_paid, inbound_payment, outbound_payment, payment_method, reference, request_trace, last_modified, created) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
