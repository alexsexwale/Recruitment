        ...
        <collapse
          ...
          color-collapse="success">
            ...
            <template slot="md-collapse-pane-4">
              ...
              <p>You understand that your content (not including banking information), may be transferred encrypted and involve (a) transmissions over various networks; and (b) changes to conform and adapt to technical requirements of connecting networks or devices. Banking information is always encrypted during transfer over networks.</p>
              ...
              <ol type="a">
                  ...
                  <li>fail to deliver payment for services delivered to you, unless the Freelancer/Client has materially changed the Microjob provided from the bid or a clear typographical error is made;</li>
                  <li>fail to deliver on the Services purchased from you, unless the Client fails to meet the terms, materially alters the terms of the Freelancer services from the listing;</li>
                  <li>circumvent or manipulate our fee structure, the billing process, or fees owed to Jobox;</li>
                  <li>post false, inaccurate, misleading, defamatory or offensive content (including personal information);</li>
              ...
              <p>By registering for a Profile, you consent to electronically receive and access, via email or the Website, all records and notices for the services provided to you under this Agreement that we would otherwise be required to provide to you in paper form.</p>
              <p>The headings used in this agreement are included for convenience only and will not limit or otherwise affect these Terms.</p>
            </template>
            <template slot="md-collapse-pane-5">
              <p>We are not responsible if information made available on this site is not accurate, complete or current. The user details on this site is provided for general information only and should not be relied upon or used as the sole basis for making decisions without consulting primary, more accurate, more complete or more timely sources of information. Any reliance on the information on this site is at your own risk.</p>
              <p>We cannot be held liable for uncomplete performances from any of the users on the Website. We cannot be held liable if a client fails to pay for a completed microjob. We are also not responsible to input enforcement mechanisms if a client refuses to pay for a complete microjob. We also cannot be held liable if a freelancer does not complete a promised performance such as showing up at the requested location, completing the microjob as agreed upon or failure to perform as promised in anyway or form that can be construed as an incomplete performance of the agreed upon Microjob. Any reliance on the information on this site is at your own risk.</p>
              <p>This site may contain certain historical information. Historical information, necessarily, is not current and is provided for your reference only. We reserve the right to modify the contents of this site at any time, but we have no obligation to update any information on our site. You agree that it is your responsibility to monitor changes to our site.</p>
              <p>Users may provide a business name or a company name, which is to be associated with the User's Profile. Users acknowledge and agree that where a business name or company name is associated with their Profile, the Terms and Conditions are a contract with the User as an individual (not the business or company) and Users remain solely responsible for all activities undertaken in respect of their Account. We may, at our absolute discretion, refuse to register a person or corporate entity as a User.</p>
            </template>
            <template slot="md-collapse-pane-6">
              <p>We charge fees for certain services, such as introduction fees for Microjobs, listing upgrades and memberships. When you use a service that has a fee, you have an opportunity to review and accept the fees that you will be charged by us for the Service that we provide which we may change from time to time and will update you by placing on our Website. We may choose to temporarily change the fees for our services for promotional events (for example, discounts on memberships) or new services, and such changes are effective when we post the temporary promotional event or new service on the Websites.</p>
              <p>Unless otherwise stated, all fees are quoted in South African rands.</p>
              <p>Jobox charges a fee for Microjobs that we provide you. Upon registering for a Profile, you agree to this charge of a fee. You also agree to allow Jobox to hold the payment of a Microjob in escrow.</p>
              <p>Jobox cannot be held liable if the Client does not make the payment for the services rendered by the Freelancer or if there is a delay in transferring the payment that is held in escrow to the Freelancer.</p>
              <p>Jobox an online venue for interactions between the Freelancer and the Client. We assist the Clients and Freelancers to make informed decisions by providing ratings and reviews but we cannot be held liable if the review and rating of a Freelancer does not match the quality of what is done or a service that is performed as we do not control the ratings and reviews of the Freelancers or the Clients.</p>
              <p>Prices for our services and products are subject to change without notice.</p>
            ...
            <template slot="md-collapse-pane-7">
              <p>Upon the Client awarding a project to a Freelancer, and the Freelancer’'s acceptance on the Website, the Client and Freelancer will be deemed to have entered into a Mircrojob Contract under which the Client agrees to purchase, and the Freelancer agrees to deliver the Client a service or services. You agree not to enter into any contractual provisions in conflict with the Microjob Contract.</p>
              <p>You are solely responsible for ensuring that you comply with your obligations to other Users. If you do not, you may become liable to that User. You must ensure that you are aware of any domestic laws (including common law), international laws, statutes, ordinances and regulations relevant to you as a Client or Freelancer, or in any other uses you make of the Website.</p>
              <p>If another User breaches any obligation to you, you are solely responsible for enforcing any rights that you may have. For the avoidance of doubt, we have no responsibility for enforcing any rights under a Microjob Contract. We merely provide a space where Freelancers and Clients can find each other and we facilitate the payment process. We are not liable for anything that may happen between the Users before the Microjob is awarded, whilst the Microjob is being performed and after the completion of the Microjob. Jobox cannot be held liable for the non-payment from the Client to the Freelancer upon the completion of a Microjob or the pro-rata payment when a Microjob is cancelled.</p>
              <p>Jobox cannot be held liable for inadequate quality of work that is done by a Freelancer.</p>
              <p>Jobox cannot be held liable in the case of a proximate Microjob, a Freelancer or Client does not show up on time or at all to the premises or location that they promised the client to be at.</p>
              <p>Jobox cannot be held liable for fake Microjob postings.</p>
              <p>Nothing in this Terms and Conditions is intended to override a right that by applicable law may not be excluded.</p>
              <p>Each User acknowledges and agrees that the relationship between Clients and Freelancers is that of an independent contractor. Nothing in this Terms and Conditions creates a partnership, joint venture, agency or employment relationship between Users.</p>
              <p>Nothing in this Terms and Conditions document shall in any way be construed as forming a joint venture, partnership or an employer-employee relationship between Jobox and the User.</p>
            </template>
            <template slot="md-collapse-pane-8">
              <b>Cancellation before the Freelancer applies</b>
              <ul>
                  <li>If a Client removes a microjob within 30 days of posting the microjob, the Client will have to pay a fee for the cancellation of the microjob</li>
                  <ul>
                      <li>The fee will be R2.50 plus a percentage cost</li>
                  </ul>
              </ul>
              <b>Cancellation of Microjob whilst the microjob is ongoing</b>
              <ul>
                  <li>Clients can cancel the microjob based on the satisfaction guaranteed</li>
                  <ul>
                      <li>Each Microjob will be dealt with on an ad-hoc basis</li>
                      <li>The Client and the Freelancer will enter into an arbitration process</li>
                      <li>If no consensus can be reached, a pro-rata payment will be made to freelancer</li>
                  </ul>
              </ul>
              <b>The freelancer cancels the contract whilst it’s in process</b>
              <ul>
                  <li>The client can be refunded if upfront payment was made</li>
              </ul>
            </template>
            ...
            <template slot="md-collapse-pane-10">
              <p>We may close, suspend or limit your access to your Profile without reason. Without limiting the foregoing, we may close, suspend or limit your access to your Profile:</p>
              <ol>
                  <li>if we determine that you have breached, or are acting in breach of this Terms and conditions;</li>
                  <li>if you under-bid on any Microjob in an attempt to renegotiate the actual price privately, avoiding the service fee;</li>
              ...
              <p>If we close your Profile for a reason other than as a result of your breach of the Terms and Conditions, unless as otherwise specified in the Terms and Conditions, you will be entitled to receive any payment due from us to you.</p>
              <p>In the event that we close your Profile, you will have no claim whatsoever against us in respect of any such suspension or termination of your Profile.</p>
            </template>
            ...
            <template slot="md-collapse-pane-13">
              ...
              <p>Unless otherwise agreed with us, you must not advertise an external website, product or service on the Website. Any website address posted on the Website, including in a listing, bid, listing description, clarification board or the message board, must relate to a Microjob, contest, item listed, user or service being performed on the Website. An example of a permissible website address would be a portfolio of work.</p>
              <p>We may display sponsor advertisements and promotions on the Website. You acknowledge and agree that we shall not be responsible for any loss or damage of any kind incurred by you as a result of the presence of such advertisements/ promotions in the Website or your subsequent dealings with the Advertisers. Furthermore, you acknowledge and agree that content of sponsor advertisements or promotions is protected by copyrights, trademarks, service marks, patents or other intellectual property or proprietary rights and laws. Unless expressly authorised by Jobox or third party right holders, you agree not to modify, sell, distribute, appropriate or create derivative works based on such advertisements/promotions.</p>
            </template>
            <template slot="md-collapse-pane-14">
              <p>You acknowledge that you transfer copyright of the feedback, reputation and reviews you leave consisting of comments and a multidimensional rating (e.g. quality, communication etc.) together with a composite rating by us. You acknowledge that such feedback, reputation and reviews belong solely to us, notwithstanding that we permit you to use it on our Website while you have an active profile. You must not use, or deal with, such feedback, reputation and reviews in any way inconsistent with our policies as posted on the Website from time to time without our prior written permission.</p>
              <p>You may not do (or omit to do) anything that may undermine the integrity of our feedback system. We are entitled to suspend or terminate your Profile at any time if we, in our sole and absolute discretion, are concerned by any feedback about you, or your feedback rating, where we believe our feedback system may be subverted.</p>
              <p>Our feedback ratings belong to us and may not be used for any purpose other than facilitating the provision of a Microjob via the Website. As a user, you may not use your feedback (including, but not limited to, marketing or exporting your any or all of your composite rating or feedback comments) in any real or virtual venue other than a website operated by Jobox or its related entities without our written permission.</p>
            ...
            <template slot="md-collapse-pane-15">
              ...
              <p>You authorise us, directly or through third parties, to make any inquiries we consider necessary to validate your identity. We may request you to: (1) provide further information to us, which may include your date of birth and other information that will allow us to reasonably identify you; (2) take steps to confirm ownership of your email address or financial instruments; or (3) verify your information against third party databases or through other sources.</p>
              <p>We reserve the right to close, suspend, or limit access to your Profile and or the Website in the event we are unable to obtain or verify to our satisfaction the information which we request under this section.</p>
            ...
            <template slot="md-collapse-pane-16">
              ...
              <ol type="I">
                  <li>the Website or any Jobox Services or Freelancer Services;</li>
                  <li>the accuracy, reliability, availability, veracity, timeliness or content of the Website or any Jobox Services or Freelancer Services;</li>
                  <li>whether the Website or Jobox Services or Freelancer Services will be up-to-date, uninterrupted, secure, error-free or non-misleading;</li>
                  <li>whether defects in the Website will be corrected;</li>
                  <li>whether the Website, Jobox Services or the Freelancer Services or any data, content or material will be backed up or whether business continuity arrangements are in place in respect of the Website, Jobox or Freelancer Services;</li>
                  <li>any third party agreements or any guarantee of business gained by you through the Website, Jobox Services or Freelancer Services ; or</li>
                  <li>the Website, Jobox Services or Freelancer Services or infrastructure on which they are based, being error or malicious code free, secure, confidential or performing at any particular standard or having any particular function.</li>
              </ol>
            </template>
            ...
            <template slot="md-collapse-pane-18">
              ...
              <p>Notwithstanding the above provisions, nothing in this Terms and Conditions is intended to limit or exclude any liability on the part of us and our affiliates and related entities where and to the extent that applicable law prohibits such exclusion or limitation including those within the Consumer Protection Act 68 of 2008 and other relevant legislation.</p>
            ...
            <template slot="md-collapse-pane-19">
              <p>You agree to indemnify, defend and hold harmless us Jobox and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms and Conditions or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
            </template>
            ...
            <template slot="md-collapse-pane-23">
              <p>These Terms and Conditions and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of the Republic of South Africa.</p>
            </template>
            ...
            <template slot="md-collapse-pane-25">
              <p>Questions about the Terms and Conditions should be sent to us at contact@jobox.co.za.</p>
            </template>
      </collapse>
      </md-card-content>
    </md-card>
