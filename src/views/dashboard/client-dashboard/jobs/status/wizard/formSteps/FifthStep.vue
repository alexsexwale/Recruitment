<template>
  <div>
    ...
    <md-field>
      ...
      <md-textarea v-model="review" type="text"></md-textarea>
    </md-field>
    <br/>
    <div style="text-align:center">
      <md-button @click="submit" class="md-success">Submit</md-button>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    submit() {
        if(interpersonal && communication && organisational && leadership && problemSolving && review) {
