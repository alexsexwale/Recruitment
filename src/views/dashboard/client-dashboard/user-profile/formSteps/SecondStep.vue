    ...
    <div class="md-layout">
      ...
      <div class="md-layout-item  ml-auto mt-4 md-small-size-100">
        <md-field :class="[
          ...
          <md-input v-model="addressLine1" data-vv-name="addressLine1" type="text" name="addressLine1" required v-validate="modelValidations.addressLine1">
          </md-input>
      ...
      <div class="md-layout-item  ml-auto mt-4 md-small-size-100">
        <md-field :class="[
          ...
          <md-input v-model="addressLine2" data-vv-name="addressLine2" type="text" name="addressLine2" required v-validate="modelValidations.addressLine2">
          </md-input>
          <slide-y-down-transition>
      ...
      <div class="md-layout-item  ml-auto mt-4 md-small-size-100">
        <md-field :class="[
          ...
          <md-icon>school</md-icon>
          <label>City</label>
          <md-input v-model="city" data-vv-name="city" type="text" name="city" required v-validate="modelValidations.city">
          </md-input>
          <slide-y-down-transition>
      ...
      <div class="md-layout-item  ml-auto mt-4 md-small-size-100">
        <md-field :class="[
          ...
          <md-input v-model="province" data-vv-name="province" type="text" name="province" required v-validate="modelValidations.province">
          </md-input>
          <slide-y-down-transition>
      ...
      <div class="md-layout-item  ml-auto mt-4 md-small-size-100">
        <md-field :class="[
          ...
          <md-input v-model="postalCode" data-vv-name="postalCode" type="text" name="postalCode" required v-validate="modelValidations.postalCode">
          </md-input>
          <slide-y-down-transition>
