          ...
          <div class="md-collapse" :class="{ 'off-canvas-sidebar': responsive }">
            <md-list>
              <md-list-item @click="linkClick">
                <router-link :to="{ path: '/register' }"><md-icon>person_add</md-icon> Become a partner</router-link>
              </md-list-item>
              <md-list-item @click="linkClick">
                <router-link :to="{ path: '/register' }"><md-icon>phone</md-icon> Contact</router-link>
              </md-list-item>
              <md-list-item @click="linkClick">
      ...
      <div class="page-header header-filter" :class="setPageClass" filter-color="black" :style="setBgImage">
        ...
        <footer class="footer">
          <div class="container md-offset">
            <nav>
              <ul>
                <li><router-link :to="{ path: '/dashboard' }">Contact Us</router-link></li>
